...
RUN echo "manylinux1_compatible = True" >> /usr/local/lib/pyenv/versions/3.6.9/lib/python3.6/site-packages/_manylinux.py && \
...
RUN apk add --no-cache --update openssl-dev binutils libc-dev && \
